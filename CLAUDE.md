...
- **`Unlimited_Seat_Analysis_2026_27.xlsx`** — Generated by `unlimited` mode (diagnostic)
  ...
  - Sheet 4 "Summary": Diagnostic totals — placement rate, sections needing split/move, courses over capacity, extra sections needed

### Engine Analysis Report
- **`Engine_Analysis_Report.xlsx`** — Generated by `analyze` mode from Job 1+2 solution data
  - Sheet 1 "Executive Summary": Overall metrics, fulfillment rates, capacity, clash breakdown, root causes, key findings
  - Sheet 2 "Process Effectiveness": Phase A-D assessments with ratings (GOOD/FAIR/POOR/CRITICAL)
  - Sheet 3 "Bottleneck Analysis": All courses with clashes — demand, capacity, spare seats, period coverage, diagnosis
  ...
  - Sheet 8 "Impact Projection": Estimated clash reduction if recommendations implemented
...
- 752 clashes (Gr9: 167, Gr10: 165, Gr11: 145, Gr12: 275), 88.5% placement (5777/6529)

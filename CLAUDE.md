...
- **`Job2_Student_Placements_2026_27.xlsx`** — Job 2 output for review after student enrollment
  ...
  - Sheet 4 "Summary": Placement rate, conflicts by grade, totals
...
4. **Student Schedule Report** (`Student_Schedule_Report_2026_27.xlsx`) — All students with S1/S2 split per period (14 period columns), credit value per course, total credits, conflicts; UNASSIGNED for empty semester slots

...
| B | Seat Students | Place 6,092 course requests using pyramid-level ordering with batch recalculation and ripple scoring |
...
|-------------|----------|----------|
| Student Course Requests | Template 2 | 2-column format: Student ID, Course Code. 6,092 requests (803 students) |

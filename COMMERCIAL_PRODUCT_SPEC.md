...
| B | Seat Students | Place 6,528 course requests using pyramid-level ordering with batch recalculation and ripple scoring |
...
|-------------|----------|----------|
| Student Course Requests | Template 2 | 2-column format: Student ID, Course Code. 6,528 requests (804 students, 143 courses) |
